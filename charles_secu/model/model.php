<?php
    ...
    function inscription($nom, $prenom, $pass, $pass_hash, $mail, $type, $adresse, $tel, $naissance)//8
    {
        // connection à la base de donnée
        include("connect_bd.php");
        ...
        {
                    $query = $bdd->prepare
                    ('INSERT INTO utilisateur (IdUtilisateur, Nom, Prenom, Naissance, MDP, crypte , Mail, TypeUser, Adresse, Tel, NomDomaine) 
                    VALUES (:IdUtilisateur, :Nom, :Prenom, :Naissance, :MDP, :crypte , :Mail, :TypeUser, :Adresse, :Tel, :NomDomaine)');
                    $query->execute
                    ([
                        'IdUtilisateur' => NULL,
                        'Nom' => $nom,
