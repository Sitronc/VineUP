    ...
    <nav class = "menu" >
        <div class="inner">
            ...
            <div class ="m-right">
                ...
                <div class ="test">
                <a href="view/FAQ.php" class="m-link"> <i class="fas fa-tractor"></i> FAQ </a>
                </div>

                <div class ="test">
                <a href="view/forum.php" class="m-link"> <i class="fas fa-tractor"></i> forum </a>
                </div>
                <!-- test menu déroulant-->
                ...
                <a href="inc/co_ins/deconnection.php" class="m-link"> <i class="fas fa-tractor"></i> conneté </a>
                </div>
