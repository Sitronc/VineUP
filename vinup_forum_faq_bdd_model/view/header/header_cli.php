<nav class = "menu" >
        <div class="inner">
            ...
            <div class ="m-right">
                ...
                <div class ="test">
                <a href="FAQ.php" class="m-link"> <i class="fas fa-tractor"></i> FAQ </a>
                </div>

                <div class ="test">
                <a href="forum.php" class="m-link"> <i class="fas fa-tractor"></i> forum </a>
                </div>
                ...
                <div class ="test">
                <a href="#" class="m-link"> <i class="fas fa-tractor"></i> Favoris </a>
                </div>
                <div class ="test">
